...
const Home: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: t("features.analyzeNutrition"),
      description: t("features.analyzeNutritionDesc"),
      link: "/analyze",
      color: "primary",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="text-center text-white">
            ...
            <div className="inline-block p-8 bg-black/30 backdrop-blur-md rounded-3xl border border-white/20 shadow-2xl mb-8">
              ...
              <p
                className={`text-xl md:text-2xl mb-0 text-white/90 max-w-3xl mx-auto animate-slide-up ${
        ...
        <div
          className="absolute bottom-20 right-10 w-32 h-32 bg-accent/30 rounded-full blur-xl animate-float"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute top-1/2 left-1/4 w-16 h-16 bg-secondary/30 rounded-full blur-xl animate-float"
