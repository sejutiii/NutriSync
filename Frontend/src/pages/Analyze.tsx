        ...
        {step === 1 && (
          <Card className="max-w-2xl mx-auto bg-gradient-card border-0 shadow-medium">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={personalData.gender} onValueChange={(value) => setPersonalData({...personalData, gender: value})}>
                    <SelectTrigger>
                      <SelectValue placeholder={language === 'bn' ? 'নির্বাচন করুন' : 'Select gender'} />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={personalData.bloodGroup} onValueChange={(value) => setPersonalData({...personalData, bloodGroup: value})}>
                    <SelectTrigger>
                      <SelectValue placeholder={language === 'bn' ? 'নির্বাচন করুন' : 'Select blood group'} />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <Button onClick={handlePersonalDataSubmit} className="w-full bg-gradient-primary">
        ...
        {step === 3 && (
          <div className="space-y-6">
            ...
            <div className="text-center">
              <Button onClick={() => {
                setStep(1);
                setPersonalData({name: '', age: '', gender: '', height: '', bloodGroup: '', area: ''});
                setConsumptionMode('');
                setSelectedFoods([]);
                setCurrentCategory('');
