...
const translations = {
  en: {
    ...
    "home.subtitle":
      "Your AI-powered nutrition companion for healthy Bengali meals",
    ...
    "features.analyzeNutrition": "Analyze Nutrition",
    "features.analyzeNutritionDesc": "Find nutrient deficiencies",
  ...
  bn: {
    ...
    "home.subtitle":
      "স্বাস্থ্যকর বাংলা খাবারের জন্য আপনার এআই-চালিত পুষ্টি সঙ্গী",
    ...
    "features.analyzeNutrition": "পুষ্টি বিশ্লেষণ",
    "features.analyzeNutritionDesc": "পুষ্টির ঘাটতি খুঁজুন",
